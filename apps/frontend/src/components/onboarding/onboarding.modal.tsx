...
import { AutopostOnboarding } from './autopost.onboarding';
...
export const OnboardingModal: FC<OnboardingModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="w-full min-h-full flex-1 p-[40px] flex relative bg-primary">
      <AutopostOnboarding onFinish={onClose} />
    </div>
  );
};
